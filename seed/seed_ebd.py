...
if __name__ == "__main__":
    # Paths
    template_path = Path(__file__).parent.parent / "documents" / "ebd" / "Executive Briefing Document (16).pptx"
    output_path = Path(__file__).parent.parent / "documents" / "ebd" / "EBD_Amazon_FILLED.pptx"
