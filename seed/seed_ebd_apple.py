...
Run: python seed/seed_ebd_apple.py
"""
...
if __name__ == "__main__":
    template = Path(__file__).parent.parent / "documents" / "ebd" / "Executive Briefing Document (16).pptx"
    output = Path(__file__).parent.parent / "documents" / "ebd" / "EBD_Apple_FILLED.pptx"
